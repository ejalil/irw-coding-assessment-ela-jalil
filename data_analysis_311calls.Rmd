...
clean_2015 <- select(call_2015, -c(1, 2,5,6,14,30,31,32,33))
#repeat this process for all data sets
clean_2016 <- select(call_2016, -c(1, 2,5,6,14,30,31,32,33))
clean_2017 <- select(call_2017, -c(1, 2,5,6,14,30,31,32,33))
clean_2018 <- select(call_2018, -c(1, 2,5,6,14,30,31,32,33))
clean_2019 <- select(call_2019, -c(1, 2,5,6,14,30,31,32,33))
clean_2020 <- select(call_2020, -c(1, 2,5,6,14,30,31,32,33))
clean_2021 <- select(call_2021, -c(1, 2,5,6,14,30,31,32,33))
clean_2022 <- select(call_2022, -c(1, 2,5,6,14,30,31,32,33))
clean_2023 <- select(call_2023, -c(1, 2,5,6,14,30,31,32,33))
clean_2024 <- select(call_2024, -c(1, 2,5,6,14,30,31,32,33))
```
