...
I want to see if there is a day that had the most calls

```{r}
blank <-clean_2024
blank$serviceorderdate2 <-as.Date(blank$serviceorderdate)
#fix this but if it takes too long just nix it
blank$serviceorderdate2 <- lubridate::dmy_hm(blank$serviceorderdate)
#This creates a new column for year
blank$year <- lubridate::year(blank$serviceorderdate2)
```
